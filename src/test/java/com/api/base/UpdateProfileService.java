...
public class UpdateProfileService extends BaseService {

	private static final String BASE_PATH = "api/UpdateProfile/";
	...
	public Response GetAssociateDetails(String token, String EmployeeID, Map<String, Object> headers) {

		if (token == null || token.isEmpty()) {

			return getRequestWithoutAuth(BASE_PATH + EmployeeID + "/GetAssociateDetails");
		}

		setHeaders(headers);
		setAuthtoken(token);
		return getRequest(BASE_PATH + EmployeeID + "/GetAssociateDetails");

	}
	
	public Response GetAssociateAddressDetails(String token, String EmployeeID, Map<String, Object> headers) {

		if (token == null || token.isEmpty()) {

			return getRequestWithoutAuth(BASE_PATH + EmployeeID + "/GetAssociateAddressDetails");
		}

		setHeaders(headers);
		setAuthtoken(token);
		return getRequest(BASE_PATH + EmployeeID + "/GetAssociateAddressDetails");

	}
	
	public Response GetAssociateDesignationDetails(String token, String EmployeeID, Map<String, Object> headers) {

		if (token == null || token.isEmpty()) {

			return getRequestWithoutAuth(BASE_PATH + EmployeeID + "/GetAssociateDesignationDetails");
		}

		setHeaders(headers);
		setAuthtoken(token);
		return getRequest(BASE_PATH + EmployeeID + "/GetAssociateDesignationDetails");
