...
public class DepartmentServiceTest {
	...
	public Object[][] departmentdata() {
		...
		return new Object[][] {
				...
				{ DepartmentCreationData.builder().functionId(1017).functionName("ACCOUNT213").functionCategory("Admin")
						.functionCode("ACCOUNT1223").departmentEmail("ACCOUNT.team@impessico.com").isUsedInTicket(1)
