...
public class DepartmentServiceTest {
	...
	public Object[][] departmentdata() {
		...
		return new Object[][] {
				...
				{ DepartmentCreationData.builder().functionId(1017).functionName("IT213").functionCategory("Admin")
						.functionCode("IT1223").departmentEmail("IT.team@impessico.com").isUsedInTicket(1)
