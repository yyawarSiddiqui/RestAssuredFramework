...
public class DepartmentServiceTest {
	...
	public Object[][] departmentdata() {
		...
		return new Object[][] {
				...
				{ DepartmentCreationData.builder().functionId(1017).functionName("ASSOCIATE213").functionCategory("Admin")
						.functionCode("ASSOCIATE1223").departmentEmail("ASSOCIATE.team@impessico.com").isUsedInTicket(1)
