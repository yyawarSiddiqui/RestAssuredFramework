...
public class ConsolidateAttendanceReport extends BaseService {

	private static final String BASE_PATH = "api/ConsolidateAttendance/";
	...
	public Response GetConsolidateAttendanceDetails(String token, String EmployeeID) {

		if (token == null || token.isEmpty()) {

			return getRequestWithoutAuth(BASE_PATH + EmployeeID + "/GetConsolidateAttendanceDetails");
		}
		setAuthtoken(token);
		return getRequest(BASE_PATH + EmployeeID + "/GetConsolidateAttendanceDetails");
