...
public class ListAssociateServiceTest {
	...
	public void setup() {
		...
		Emp_id = getEmployeeID(RM);
		token = AuthTokenProvider.getToken(RM);
		listAssociate = new ListAssociateService();
		employeedetailID = GetEmployeedetailID(RM);
	}
	...
	public void test_GetMinimumCommitmentRMs(int associateid, int commitmentids) {
