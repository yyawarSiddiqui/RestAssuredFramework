...
public class DepartmentServiceTest {
	...
	public Object[][] departmentdata() {
		...
		return new Object[][] {
				...
				{ DepartmentCreationData.builder().functionId(1017).functionName("RM213").functionCategory("Admin")
						.functionCode("RM1223").departmentEmail("RM.team@impessico.com").isUsedInTicket(1)
